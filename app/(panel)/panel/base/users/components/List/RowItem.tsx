...
export const RowItem = (ad: UserListType) => {
    ...
    return (
        <div className='grid grid-cols-4 gap-1 p-1.5 text-space-codet text-body-2-normal items-center'>
                    ...
                    {more &&
                        <ClickAwayListener onClickAway={() => setMore(false)}>
                            ...
                            <div className='absolute shadow-sm rounded border flex flex-col  items-stretch min-w-[234px] top-full bg-white z-20 left-1/2 -transla te-x-1/2 text-body-3-normal'>
                                <div className='flex flex-row gap-2 items-center justify-between hover:bg-gray-100 transition-all p-1' onClick={() => dispatch({ mode: 'edit', userId: ad.id.toString() })}>
                                    <span>ویرایش</span>
