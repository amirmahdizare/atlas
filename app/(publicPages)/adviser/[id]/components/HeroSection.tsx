...
export const HeroSection = () => {
    return (
        <div className='grid grid-cols-3 relative items-center justify-center bg-white'>
            <div className=' col-span-3 md:col-span-2 flex flex-col gap-4 p-2 lg:p-4'>

                <div className='flex flex-col gap-2'>
                    <span className='text-h3-bolder'>
                        <span className='text-space-codet'>امیرحسین کشن زارع</span>
                        &nbsp;
                        &nbsp;
                        <span className='text-robin-egg'>کارشناس دپارتمان اطلس</span>
                    </span>
                    <p className='leading-3 text-ultra-violet text-h6-normal'>
                        <span>خانه دلخواهتان را به کمک مشاور متخصص </span>
                ...
                <div className='flex flex-row gap-2'>
                    ...
                    <a href={'tel:09196442725'}><Button bgColor='gray' icon={IconArrowDownLeft} textColor='dark' iconSide='left' href='requestproperty'>تماس با مشاور</Button></a>
