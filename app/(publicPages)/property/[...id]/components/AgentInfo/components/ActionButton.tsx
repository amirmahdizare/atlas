...
export const ActionButton = ({ phoneNumber , isPopUp}: { phoneNumber: string , isPopUp:boolean}) => {
    return (
        <div className='flex flex-row gap-1 items-center'>
            ...
            <div className='flex flex-row gap-1.5 items-center'>
                ...
                {!isPopUp && <IconCopy className='cursor-pointer text-gray-400 hidden lg:flex hover:text-gray-500' onClick={() => {
